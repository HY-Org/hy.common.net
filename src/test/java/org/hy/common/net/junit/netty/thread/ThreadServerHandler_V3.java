 ...
 * @version     v1.0
 */
public class ThreadServerHandler_V3 extends SimpleChannelInboundHandler<String>
{

    private static final Logger $Logger = new Logger(ThreadServerHandler_V3.class ,true);
